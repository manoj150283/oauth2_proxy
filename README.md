...
[![Build Status](https://secure.travis-ci.org/manoj150283/oauth2_proxy.png?branch=master)](http://travis-ci.org/manoj150283/oauth2_proxy)
...
1. Download [Prebuilt Binary](https://github.com/manoj150283/oauth2_proxy/releases) (current release is `v2.0.1`) or build with `$ go get github.com/manoj150283/oauth2_proxy` which will put the binary in `$GOROOT/bin`
